// Task 3
// Write a Java program that contains a class named Rectangle with two instance
// variables: length and
// width. The class should have the following methods:
...
// rectangle.
// Additionally, create another class named RectangleOperations that contains
// the main method. Within
// the main method:
// Create an object of the Rectangle class.
// Use the object to call the assignValues method and assign sample values to
