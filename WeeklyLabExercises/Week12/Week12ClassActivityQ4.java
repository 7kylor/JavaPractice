// 4. Create a diagram and justify inheritance hierarchy that could be used to
...
class Week12ClassActivityQ4 {
    public static void main(String[] args) {
        Manager manager = new Manager();
        manager.inputDetails(1, "Taher");
        manager.displayDetails();
        manager.getSalary();
        manager.getBonus();

        Student student = new Student();
        student.inputDetails(2, "Ali");
