...
// position, and salary, and two
// member functions: void input() to assign input values using parameters passed
// from the main
// method and void display() to display the values. Appropriate data types are
// to be chosen for the
// data members. Define another class that hosts the main method. Inside the
// main method:
